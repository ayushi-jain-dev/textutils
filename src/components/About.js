...
export default function About(props) {
	...
	let myStyle = {
		color: props.mode === 'dark' ? 'whitesmoke' : '#042743',
		backgroundColor: props.mode === 'dark' ? '#215b67' : 'white',
	}
	return (
		<div className="container">
			<h1 className="my-3" style={{color: props.mode === 'dark' ? 'whitesmoke' : '#042743'}}>About Us</h1>
				...
				<div className="accordion-item">
					...
					>
						<div className="accordion-body" style={myStyle}>
							...
							or removing extra spaces from your text and fetching email from your text.
